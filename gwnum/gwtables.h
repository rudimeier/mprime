...
struct gwasm_data {
	...
	void	*norm_ptr1;
	void	*norm_ptr2;
	intptr_t normblkdst;		/* Dist between blocks in normalization of in-place two-pass FFTs */
	intptr_t normblkdst8;		/* Dist between 8 blocks in normalize of two-pass FFTs using scratch area */
	...
	union {
		...
		void	*sincos11;		/* Sin/cos table pointers only used by SSE2 home-grown FFTs */
		void	*pass2_premults;	/* Address of pass 2 premultiplier data for home-grown FFTs */
		void	*UNUSED_XMM_PTRS[12];
