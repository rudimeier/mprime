...
buildfor                        + K8            ,	r4delay_pass1sc128 32K, 8, 2
buildfor CORE_64 + P4                           ,	r4delay_pass1sc256 64K, 8, 4
buildfor                                + K10   ,	r4delay_pass1sc256 64K, 8, 2
buildfor                        + K8            ,	r4delay_pass1sc256 64K, 8, 1
buildfor CORE_32 + P4_64                        ,	r4delay_pass1sc320 80K, 8, 4
buildfor                 + P4TP + K8_32 + K10_64,	r4delay_pass1sc320 80K, 8, 2
buildfor                        + K8_64         ,	r4delay_pass1sc320 80K, 8, 1
...
buildfor                        + K8            ,	r4delay_pass1sc256 256K, 10, 2
...
buildfor                                + K10   ,	r4delay_pass1sc320 320K, 10, 1
buildfor CORE_64 + P4    + P4TP                 ,	r4delay_pass1sc320 400K, 1280, 4
buildfor CORE_32         + P4TP                 ,	r4delay_pass1sc320 400K, 1280, 2
buildfor                        + K8    + K10   ,	r4delay_pass1sc320 400K, 1280, 1
...
buildfor                        + K8    + K10_64,	r4delay_pass1sc384 384K, 10, 1
buildfor                                        ,	r4delay_pass1sc384 480K, 1280, 4
buildfor                                        ,	r4delay_pass1sc384 480K, 1280, 2
buildfor                        + K8    + K10_64,	r4delay_pass1sc384 480K, 1280, 1
...
buildfor CORE_64         + P4TP + K8_64         ,	r4delay_pass1sc448 448K, 10, 2
buildfor                        + K8_32         ,	r4delay_pass1sc448 448K, 10, 1
...
buildfor                        + K8            ,	r4delay_pass1sc512 512K, 10, 2
...
buildfor                        + K8            ,	r4delay_pass1sc640 800K, 1280, 1
...
buildfor                 + P4TP         + K10_32,	r4delay_pass1sc320 640K, 11, 2
...
buildfor                 + P4TP         + K10_64,	r4delay_pass1sc384 576K, 1536, 2
...
buildfor                        + K8    + K10_64,	r4delay_pass1sc448 672K, 1536, 1
buildfor CORE_32                        + K10_32,	r4delay_pass1sc448 896K, 11, 4
buildfor                 + P4TP                 ,	r4delay_pass1sc448 896K, 11, 2
